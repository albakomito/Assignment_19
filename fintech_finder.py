...
account = st.sidebar.write(generate_account(w3))
...
balance = st.sidebar.write.get_balance(account.address)
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(account, wage,candidate_address)
